...
void           phosh_revealer_set_transition_duration (PhoshRevealer *self, guint transition_duration);
GtkRevealerTransitionType phosh_revealer_get_transition_type (PhoshRevealer *self);
void                      phosh_revealer_set_transition_type (PhoshRevealer *self, GtkRevealerTransitionType transition_type);
